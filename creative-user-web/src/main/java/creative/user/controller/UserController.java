...
public class UserController {
    ...
    public ResponseEntity login(@RequestBody final LoginRequest pLoginRequest) {
        ...
        final boolean requestValid = getUserService().validateLoginRequest(pLoginRequest);
        if (!requestValid) {
    ...
    public ResponseEntity registerUser(@RequestBody final RegistrationRequest pRegistrationRequest) {
        ...
        final boolean requestValid = getUserService().validateRegistrationRequest(pRegistrationRequest);
        if (!requestValid) {
    ...
    public ResponseEntity updateCurrentUser(@RequestBody final UpdateUserRequest pUpdateUserRequest) {
        final boolean requestValid = getUserService().validateUpdateUserRequest(pUpdateUserRequest);
        if (!requestValid) {
