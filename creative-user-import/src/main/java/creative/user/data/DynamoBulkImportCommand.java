 ...
 *
 */
public abstract class DynamoBulkImportCommand {
    // Logger for this class
    private static final Log log = LogFactory.getLog(DynamoBulkImportCommand.class);
    ...
    /**  */
    public DynamoBulkImportCommand() {
        super();
    }
    ...
    private AWSCredentialsProvider createAmazonAWSCredentialsProvider(final String amazonAWSAccessKey, final String amazonAWSSecretKey) {
    ...
    private AmazonDynamoDB createAmazonDynamoDB(final String amazonDynamoDBEndpoint, final String amazonAWSAccessKey, final String amazonAWSSecretKey) {
